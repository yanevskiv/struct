...
TODO:
    ...
    DEFINE_STRUCT_LIST_SERIALIZE(NAME, T)
    DEFINE_STRUCT_LIST_SERIALIZE(NAME, T)
    DEFINE_STRUCT_LIST_SERIALIZE_INDEX(NAME, T)
    DEFINE_STRUCT_LIST_SERIALIZE_INDEX_DATA(NAME, T)

    DEFINE_STRUCT_LIST_UNSERIALIZE(NAME, T)
    DEFINE_STRUCT_LIST_UNSERIALIZE_DATA(NAME, T)
    DEFINE_STRUCT_LIST_UNSERIALIZE_INDEX(NAME, T)
    DEFINE_STRUCT_LIST_UNSERIALIZE_INDEX_DATA(NAME, T)
